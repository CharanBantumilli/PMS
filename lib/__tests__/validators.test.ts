...
describe('registerSchema', () => {
  ...
  it('accepts without optional country — currency defaults to USD', () => {
  ...
  it('accepts multiple currencies (USD, EUR, GBP, INR, etc.)', () => {
    for (const cur of ['USD', 'EUR', 'GBP', 'INR', 'AUD', 'CAD', 'SGD', 'AED', 'JPY', 'CHF']) {
      const result = registerSchema.safeParse({
        organizationName: 'Test',
        organizationSlug: 'test',
        name: 'Alex',
...
describe('unitTypeSchema', () => {
  const valid = { name: 'Standard Queen' };

...
export function ExpenseDialog({ mode, initial, onClose }: { mode: 'create' | 'edit'; initial?: Initial; onClose?: () => void }) {
  ...
  const formInner = (
    <form onSubmit={onSubmit} className="grid grid-cols-2 gap-3">
      ...
      <div className="space-y-1.5"><Label htmlFor="expenseDate">Date</Label><DateInput name="expenseDate" required defaultValue={initial?.expenseDate?.slice(0,10) || new Date().toISOString().slice(0,10)} /></div>

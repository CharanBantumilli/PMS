        ...
        <div className="absolute right-0 top-12 z-50 w-96 overflow-hidden rounded-lg border bg-white shadow-xl">
          <div className="flex items-center justify-between border-b px-4 py-3">
            ...
            <div className="flex items-center gap-1">
              ...
              <Link href="/dashboard/notifications" onClick={() => setOpen(false)} className="rounded p-1 text-xs text-blue-600 hover:bg-blue-50">
                View all
              </Link>
            </div>
          </div>
          ...
          {notifications.length > 0 && (
            <div className="border-t bg-slate-50 px-4 py-2 text-center">
              <Link href="/dashboard/notifications" onClick={() => setOpen(false)} className="text-xs font-medium text-blue-600 hover:underline">

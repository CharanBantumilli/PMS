    ...
    <Dialog open onOpenChange={(o) => { if (!o) onClose?.(); }}>
      <DialogContent>
        ...
        <form onSubmit={onSubmit} className="grid grid-cols-2 gap-3">
          ...
          <div className="space-y-1.5"><Label htmlFor="startDate">Start date</Label><DateInput name="startDate" required /></div>
          <div className="space-y-1.5"><Label htmlFor="endDate">End date</Label><DateInput name="endDate" required /></div>

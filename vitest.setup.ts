...
beforeEach(() => {
  ...
  vi.mocked(prisma.guest.count).mockResolvedValue(0 as any);
  ...
  vi.mocked(prisma.payment.update).mockResolvedValue(0 as any);
  ...
  vi.mocked(prisma.expense.count).mockResolvedValue(0 as any);
  ...
  vi.mocked(prisma.otpCode.findFirst).mockReset();
  vi.mocked(prisma.otpCode.updateMany).mockResolvedValue(0 as any);

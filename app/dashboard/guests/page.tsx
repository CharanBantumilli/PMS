  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <Button asChild><Link href="/dashboard/guests/new"><Plus className="h-4 w-4" /> New guest</Link></Button>
      </div>
      ...
      {guests.length === 0 ? (
        <Card><CardContent className="py-16 text-center">
          ...
          <Button asChild className="mt-4"><Link href="/dashboard/guests/new">Add guest</Link></Button>
        </CardContent></Card>
      ) : (
